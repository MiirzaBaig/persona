...
const RiveAnimation = ({ src, stateMachine, isActive, artboard }: RiveAnimationProps) => {
  ...
  return (
    ...
    <div className="absolute  w-[360px] aspect-[125/101] md:w-[500px] right-0 md:right-auto">
      ...
      <div className={`w-full absolute z-10 top-0  left-0 h-20 bg-gradient-to-b from-whiteout to-transparent`} />
      <div className={`h-full absolute z-10 top-0 w-4 md:w-20 right-[-5px] bg-gradient-to-l blur-[1px] from-whiteout via-whiteout to-transparent`}/>
      <div className={`w-4 md:w-20  absolute top-0 z-10 left-0 h-full bg-gradient-to-r blur-[1px] from-whiteout via-whiteout to-transparent`}/>
