...
const EXPERIENCE: Experience[] = [
  {
    ...
    points: [
      "Building and shipping software at PureSoft Labs, contributing to core engineering efforts.",
      "Developing scalable applications using modern web technologies and cloud infrastructure.",
    ],
  },
  {
    ...
    points: [
      "Leading Web3 security and blockchain protection initiatives from the ground up.",
      "Architecting smart contract security tooling and blockchain monitoring systems.",
    ],
  },
  {
    title: "Software Engineer",
    ...
    points: [
      "Building the marketplace for modern M&A with deal rooms, document workflows, and collaboration tools.",
  ...
  },
  {
    ...
    points: [
      "Selected for McKinsey's Forward Program, developing leadership and problem-solving capabilities.",
      "Collaborated on strategic initiatives and applied analytical frameworks to real-world business challenges.",
    ],
  },
  {
